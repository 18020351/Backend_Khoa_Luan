...
namespace SheduleManagement.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public IActionResult AddUser(AddUserModel model)
        {
            ...
            UserService userService = new UserService(_dbContext);
            var (message, user) = userService.AddUser(model.UserName, model.FirstName, model.LastName, model.Password, model.Phone, model.Address, model.Position, model.Department);
            if (user != null)
            {
